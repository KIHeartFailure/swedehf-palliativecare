...
outcomesfunc_outer(
  ...
  impdatanb = imprsdata0, xvar = "shf_palliative_indicated"
)
```
...
outcomesfunc_outer(
  data = rsdata %>% filter(!is.na(shf_palliative_given)),
  impdata = imprsdata, impdatanb = imprsdata0, xvar = "shf_palliative_given"
)
```
